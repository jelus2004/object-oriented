...
public class Banque {
    ...
    public static void main(String[] args) {
        ...
        Client client1 = new Client("Pedro", "Genève", 1000.0, tauxPrive, 2000.0, tauxEpargne, true);
        Client client2 = new Client("Alexandra", "Lausanne", 3000.0, tauxPrive, 4000.0, tauxEpargne, false);
